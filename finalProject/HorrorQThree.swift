                    ...
                    ToolbarItemGroup(placement: .bottomBar) {
                        ...
                        ZStack {
                            ...
                            HStack{
                                ...
                                NavigationLink(destination: RecsView()) {
                                    Image(systemName: "video").foregroundColor(Color.black)
                                }
                                .padding()
                                //This takes you to the recommended list for music
                                NavigationLink(destination: RecsView()) {
                                    Image(systemName: "headphones").foregroundColor(Color.black)
                                }
                                .padding()
                                //This takes you to the recommended list for books
                                NavigationLink(destination: RecsView()) {
                                    Image(systemName: "book").foregroundColor(Color.black)
                                }
                                .padding()
                                //This takes you to the recommended list for list.bullet
                                NavigationLink(destination: RecsView()) {
                                    Image(systemName: "list.bullet").foregroundColor(Color.black)
                                }
                                .padding(2)
                            }
                        }
